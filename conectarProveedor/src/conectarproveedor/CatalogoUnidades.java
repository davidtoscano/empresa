...
public class CatalogoUnidades extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Clave de la Unidad");

        jLabel7.setText("Descripcion de la Unidad");

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setText("Catalogo Unidades");
    ...
    private void jbtnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnguardarActionPerformed
        ...
        try {
            ...
            //Reemplaza valores 
            String sentenciaInsert = "insert into unidades values (?,?)";
    ...
    private void jbtnmostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnmostrarActionPerformed
        try {
            conectar miconexion = new conectar();
            String cons = "select * from unidades";
